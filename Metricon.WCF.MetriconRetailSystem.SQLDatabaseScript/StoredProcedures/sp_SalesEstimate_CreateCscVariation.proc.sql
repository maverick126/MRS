...
*/
IF  (NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sp_SalesEstimate_CreateCscVariation]') AND type in (N'P', N'PC')))
	BEGIN
		EXEC dbo.sp_executesql @statement = N'
		CREATE PROCEDURE [dbo].[sp_SalesEstimate_CreateCscVariation]
		AS
		BEGIN
			SET NOCOUNT ON;
		END';
...
ALTER PROCEDURE [dbo].[sp_SalesEstimate_CreateCscVariation]
